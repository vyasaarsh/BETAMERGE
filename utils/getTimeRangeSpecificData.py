...
def get_time_specific_data(time_range, parsed1s_data, parsed1m_data, parsed1h_data):
    ...
    match time_range:
        # Hourly aggregations
        case TimeRange.LAST_YEAR_HOURLY:
        ...
        case TimeRange.CURRENT_YEAR_HOURLY:
        ...
        # Minute aggregations
        case TimeRange.LAST_MONTH_MINUTE:
        ...
        case TimeRange.LAST_WEEK_MINUTE:
        ...
        # Second aggregations
        case TimeRange.YESTERDAY_SECOND:
